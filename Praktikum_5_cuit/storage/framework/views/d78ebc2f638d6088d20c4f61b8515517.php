  ...
  <div class="w-[50%] mx-auto py-10">
    ...
    <div class="flex justify-between items-center mb-5">
      ...
      <form action="<?php echo e(route('logout')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition">Logout</button>
      </form>
    </div>
...
<?php /**PATH C:\xampp\htdocs\cuit\resources\views/home.blade.php ENDPATH**/ ?>