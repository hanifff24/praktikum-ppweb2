...
<body>
        ...
        <form class="mx-auto" action="form_nilai_get.php" method="GET">
            ...
            <div class="form-group row">
                <div class="offset-5 col-7">
                    <button type="submit" name="proses" class="btn btn-primary" value="Simpan" target="blank">Simpan</button>
                </div>
            </div>
        </form>
    </main>
    ...
    <footer class="mt-5" style="bottom: 0; left: 0; right: 0; position: fixed;">
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div class="container d-flex justify-content-center">
                <a class="navbar-brand text-center" href="#">Develop By @Hanif &copy;<?= date("Y") ?></a>
            </div>
        </nav>
    </footer>
    -->
